...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="purchaseLabel" aria-hidden="true" ng-controller="UserSetCtr as user_app">
            ...
            <div class = "container">
                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-xs-4">
                            <input type="text" id="userFirstName" class="form-control" ng-model="user_app.user.userFirstName" placeholder="Firstname">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-4">
                            <input type="text" id="userLastName" class="form-control" ng-model="user_app.user.userLastName" placeholder="Lastname">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-4">
                            <input type="email" id="userEmail" class="form-control"  ng-model="user_app.user.userEmail" placeholder="Email">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-4">
                            <input type="password" id="userPassword" class="form-control"  ng-model="user_app.user.userPassword" placeholder="Password">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-xs-offset-2 col-xs-4">
                            ...
                            <button type="button" class="btn btn-primary" ng-click="user_app.addUser(web_ca.user)">Register</button>
                        </div>
                    </div>
                </form>
            </div>
